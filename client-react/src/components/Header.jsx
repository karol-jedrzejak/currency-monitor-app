    ...
    <nav className="relative w-full border-b border-gray-900 dark:border-gray-500 z-50">
      <div className="flex items-center justify-between px-6 py-3">
        ...
        <div className="hidden md:flex items-center space-x-6">
          <a href="#home" className="rounded-md px-3 py-2 text-sm font-medium text-gray-700 hover:text-gray-900 dark:text-gray-300 dark:hover:text-gray-50 bg-gray-100 dark:bg-gray-900 hover:bg-gray-300 dark:hover:bg-gray-700">Strona główna</a>
          ...
          {/* Theme switch */}
          <div className="inline-flex items-stretch p-2 rounded-md bg-zinc-200 dark:bg-zinc-800 h-fit">
            <button onClick={() => themeData.changeTheme()} className="p-1 cursor-pointer rounded-md bg-zinc-200 text-zinc-800 hover:bg-zinc-100 hover:text-zinc-900 dark:bg-zinc-800 dark:text-zinc-200 dark:hover:bg-zinc-900 dark:hover:text-zinc-100">
